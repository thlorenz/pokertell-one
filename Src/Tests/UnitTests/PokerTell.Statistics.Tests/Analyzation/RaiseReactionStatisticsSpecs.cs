    ...
    public abstract class RaiseReactionStatisticsSpecs
    {
         ...
         *  Intitializing with RaiseReactionsAnalyzer
              ...
              RaiseReactionsAnalyzer returns zero raiseSizes
                ...
                RaiseReactionsAnalyzer returns two raiseSizes and one RaiseReactionAnalyzer with HeroReactionType of firstRow and ConsideredRaiseSize of firstColumn
                ...
                RaiseReactionsAnalyzer returns two raiseSizes and a RaiseReactionAnalyzer with HeroReactionType of firstRow and ConsideredRaiseSize of firstColumn and another RaiseReactionAnalyzer with HeroReactionType of thirdRow and ConsideredRaiseSize of firstColumn
                    » count of AnlyzablePokerPlayersDictionary at first row and first column should be 1
        ...
        public abstract class Ctx_with_raiseReactionsAnalyzer_that_returns_two_raiseSizes_and_a_raiseReactionAnalyzer_with_HeroReactionType_of_firstRow_and_ConsideredRaiseSize_of_firstColumn
            : RaiseReactionStatistics_with_raiseReactionsAnalyzer_that_returns_two_raiseSizes
        {
            Establish context = () =>
            {
                ...
                firstReactionAnalyzerStub.SetupGet(a => a.ConsideredRaiseSize).Returns(firstColumn);
            };
        ...
        public class RaiseReactionStatistics_with_raiseReactionsAnalyzer_that_returns_two_raiseSizes_and_a_RaiseReactionAnalyzer_with_HeroReactionType_of_firstRow_and_OpponentRaiseSize_of_firstColumn_and_another_RaiseReactionAnalyzer_with_HeroReactionType_of_thirdRow_and_OpponentRaiseSize_of_firstColumn
            : Ctx_with_raiseReactionsAnalyzer_that_returns_two_raiseSizes_and_a_raiseReactionAnalyzer_with_HeroReactionType_of_firstRow_and_ConsideredRaiseSize_of_firstColumn
        {
            Establish context = () =>
            {
                ...
                secondReactionAnalyzerStub.SetupGet(a => a.ConsideredRaiseSize).Returns(firstColumn);
            };
        ...
        [Subject(typeof(RaiseReactionStatistics), "intitializing with RaiseReactionsAnalyzer")]
        public class RaiseReactionsAnalyzer_returns_two_raiseSizes_and_one_RaiseReactionAnalyzer_with_HeroReactionType_of_firstRow_and_ConsideredRaiseSize_of_firstColumn
            : Ctx_with_raiseReactionsAnalyzer_that_returns_two_raiseSizes_and_a_raiseReactionAnalyzer_with_HeroReactionType_of_firstRow_and_ConsideredRaiseSize_of_firstColumn
        {
            Because of = () =>
            {
        ...
        [Subject(typeof(RaiseReactionStatistics), "intitializing with RaiseReactionsAnalyzer")]
        public class RaiseReactionsAnalyzer_returns_two_raiseSizes_and_a_RaiseReactionAnalyzer_with_HeroReactionType_of_firstRow_and_ConsideredRaiseSize_of_firstColumn_and_another_RaiseReactionAnalyzer_with_HeroReactionType_of_thirdRow_and_OpponentRaiseSize_of_firstColumn
