namespace PokerTell.PokerHand.ViewModels.Design
{
    ...
    internal class DesignHelper
    {
        ...
        internal IConvertedPokerHand CreateSamplePokerHand(int index)
        {
            ...
            player1.Add(_roundMake.New);
            player1[Streets.PreFlop].Add(_actionMake.New.InitializeWith(ActionTypes.C, 0.2));
            player1.Add(_roundMake.New);
            player1[Streets.Flop].Add(_actionMake.New.InitializeWith(ActionTypes.B, 0.3));
            player1.Add(_roundMake.New);
            player1[Streets.Turn].Add(_actionMake.New.InitializeWith(ActionTypes.B, 0.5));
            player1[Streets.Turn].Add(_actionMake.New.InitializeWith(ActionTypes.C, 0.4));
            player1.Add(_roundMake.New);
            player1[Streets.River].Add(_actionMake.New.InitializeWith(ActionTypes.B, 0.9));

            var player2 = _playerMake.New.InitializeWith("player2", 12 + index, 4, 1, 6, "9h Qd");
            player2.Add(_roundMake.New);
            player2[Streets.PreFlop].Add(_actionMake.New.InitializeWith(ActionTypes.X, 1.0));

            var player3 = _playerMake.New.InitializeWith("player3", 13 + index, 2, 2, 6, "?? ??");
            player3.Add(_roundMake.New);
            player3[Streets.PreFlop].Add(_actionMake.New.InitializeWith(ActionTypes.C, 0.3));
            player3.Add(_roundMake.New);
            player3[Streets.Flop].Add(_actionMake.New.InitializeWith(ActionTypes.C, 0.2));
            player3.Add(_roundMake.New);
            player3[Streets.Turn].Add(_actionMake.New.InitializeWith(ActionTypes.R, 3.0));
            player3[Streets.Turn].Add(_actionMake.New.InitializeWith(ActionTypes.C, 0.2));
            player3.Add(_roundMake.New);
            player3[Streets.River].Add(_actionMake.New.InitializeWith(ActionTypes.C, 0.2));

            var player4 = _playerMake.New.InitializeWith("player4", 14 + index, 4, 3, 6, "?? ??");
            player4.Add(_roundMake.New);
            player4[Streets.PreFlop].Add(_actionMake.New.InitializeWith(ActionTypes.F, 1.0));

            var player5 = _playerMake.New.InitializeWith("player5", 15 + index, 3, 4, 6, "?? ??");
            player5.Add(_roundMake.New);
            player5[Streets.PreFlop].Add(_actionMake.New.InitializeWith(ActionTypes.C, 0.3));

            var player6 = _playerMake.New.InitializeWith("player6", 16 + index, 14, 5, 6, "?? ??");
            player6.Add(_roundMake.New);
            player6[Streets.PreFlop].Add(_actionMake.New.InitializeWith(ActionTypes.F, 1.0));
