    ...
    public class DetailedPreFlopStatisticsViewModel : DetailedStatisticsViewModel
    {
            ...
            : base("Position")
        {
            Rows = new List<IRowViewModel>
                {
                    new RowViewModel("Fold", new[] { 20, 30, 12, 40, 30, 12,23 }, "%"),
                    new RowViewModel("Call", new[] { 10, 35, 7, 60, 30, 12,90 }, "%"),
                    new RowViewModel("Raise", new[] { 9, 44, 56, 70, 30, 12, 44 },  "%"),
                    new RowViewModel("Count", new[] { 1, 4, 30, 34, 33, 30, 12, 45 }, string.Empty)
                };
        }
