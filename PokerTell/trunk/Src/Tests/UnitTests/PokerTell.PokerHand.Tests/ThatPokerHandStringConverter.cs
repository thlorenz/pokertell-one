namespace PokerTell.PokerHand.Tests
{
    ...
    public class ThatPokerHandStringConverter
    {
        ...
        [Test]
        public void BuildSqlStringFrom_EmptyRound_ReturnsEmptyString()
        {
        ...
        [Test]
        public void ConvertedRoundFrom_EmptyString_ReturnsRoundWithoutActions()
        {
