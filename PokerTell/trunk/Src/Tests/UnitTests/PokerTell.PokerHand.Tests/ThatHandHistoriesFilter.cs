namespace PokerTell.PokerHand.Tests
{
    ...
    public class ThatHandHistoriesFilter
    {
        ...
        public void BinaryDeserialize_Serialized_RestoresHeroName()
        {
            ...
            Assert.That(_historiesFilter.BinaryDeserializedInMemory().HeroName, Is.EqualTo(_historiesFilter.HeroName));
        }
            ...
            [Values(true, false)] bool parameter)
        {
            ...
            Assert.That(
                _historiesFilter.BinaryDeserializedInMemory().SelectHero, Is.EqualTo(_historiesFilter.SelectHero));
        }
            ...
            [Values(true, false)] bool parameter)
        {
            ...
            Assert.That(
                _historiesFilter.BinaryDeserializedInMemory().ShowAll, Is.EqualTo(_historiesFilter.ShowAll));
        }
            ...
            [Values(true, false)] bool parameter)
        {
            ...
            Assert.That(
                _historiesFilter.BinaryDeserializedInMemory().ShowMoneyInvested, Is.EqualTo(_historiesFilter.ShowMoneyInvested));
        }
            ...
            [Values(true, false)] bool parameter)
        {
          _historiesFilter.ShowPreflopFolds = parameter;
            Assert.That(
                _historiesFilter.BinaryDeserializedInMemory().ShowPreflopFolds, Is.EqualTo(_historiesFilter.ShowPreflopFolds));
        }
            ...
            [Values(true, false)] bool parameter)
        {
            ...
            Assert.That(
                _historiesFilter.BinaryDeserializedInMemory().ShowSawFlop, Is.EqualTo(_historiesFilter.ShowSawFlop));
        }
            ...
            [Values(true, false)] bool parameter)
        {
            ...
            Assert.That(
                _historiesFilter.BinaryDeserializedInMemory().ShowSelectedOnly, Is.EqualTo(_historiesFilter.ShowSelectedOnly));
        }
